        ...
        <div className={style["featured-container"]}>
            <div className={style["card-container"]}>
                ...
                <div className="card-heading">
                    <div className="padding-l-r-16-b-5 heading bg-black white">Ferrari</div>
                </div>
                <div className="card-typography fluid-y">
                    ...
                    <div className="card-footer-basic fluid-x bg-black">
                        <button className={`${style["footer-btn"]} btn btn-primary`}>Play Now</button>
                    </div>
                </div>
                <div className="card-container ">
                    ...
                    <div className="card-heading">
                        <div className="padding-l-r-16-b-5 heading bg-black white">Netflix</div>
                    </div>
                    <div className="card-typography fluid-y">
